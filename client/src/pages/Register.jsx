          ...
          <Form onSubmit={registerUser}>
            <Row style={{height:'80vh',justifyContent:'center',paddingTop:'7%'}}>
                <Col xs={6}>
                    <Stack gap={3}>
                      <h2>Register</h2>
                      <Form.Control type='text' placeholder='Your Name' onChange={(e)=>updateRegisterInfo({...registerInfo,name:e.target.value})}/>
                      ...
                      <Button variant='primary' type='submit'>{ isRegisterLoading ?'Submitting...':"Register"}</Button>
                      {  registerError?.error && (
